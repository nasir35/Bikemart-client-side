...
const FeatureProducts = () => {
    ...
    useEffect( () => {
        fetch('https://frozen-scrubland-17701.herokuapp.com/feature-products')
        .then(res => res.json())
    ...
    return (
        <div className="md:p-12 sm:p-8 p-4">
            ...
            <h2 className="sm:text-2xl text-xl font-qsand inline-block border-b-4 border-green-custom rounded px-4 text-stromboli font-medium">Feature Bicycles</h2>
            </div>
